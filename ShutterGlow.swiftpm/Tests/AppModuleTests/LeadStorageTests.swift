...
final class LeadStorageTests: XCTestCase {
    ...
    private func makeEvent(_ label: String) -> String {
    ...
    func testDeleteLeadsRemovesContactsAndReportsHowMany() {
        let event = makeEvent("delete")
    ...
    func testDeleteLeadsKeepsThePhotos() throws {
        ...
        let event = makeEvent("keepphotos")
        storage.appendLead(lead("Alex"), eventId: event)
    ...
    func testDeleteLeadsOnAnEventWithNoneIsHarmless() {
        let event = makeEvent("empty")
    ...
    func testPurgeAllLeadsClearsEveryEventAndLeavesPhotos() throws {
        ...
        let a = makeEvent("purge-a")
        let b = makeEvent("purge-b")
    ...
    func testEventsHoldingLeadsExcludesEmptyOnes() {
        ...
        // delete nothing.
        let withLeads = makeEvent("holding")
        let without = makeEvent("notholding")
    ...
    func testOldestLeadDateIsTheEarliestNotTheLatest() {
    ...
    func testOldestLeadDateIsNilWithNoLeads() {
        XCTAssertNil(storage.oldestLeadDate(eventId: makeEvent("nooldest")))
    }

    func testLeadsCSVEscapesAFormulaSoASpreadsheetCannotRunIt() {
    ...
    func testLeadsCSVIsJustTheHeaderAfterDeletion() {

...
public enum CameraBrand: String, CaseIterable, Sendable, Identifiable {
    ...
    public var connectionHint: String {
        ...
        // Body list verified against vendor documentation 2026-07-31. An
        // earlier version named two products that do not exist ("R6 V", and
        // a Panasonic "L10" that is not a Lumix), which is worse than a short
        // list — an operator could buy the wrong body off this screen. Check
        // a vendor manual before adding anything here.
        //
